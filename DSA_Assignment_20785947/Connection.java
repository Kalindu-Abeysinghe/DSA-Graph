...
Purpose: This class is created to model the connections into objects and store them as a DSAGraphEdge
...
public class Connection implements Serializable
{
    ...
    public String getBarriers() { return barriers; }

    public void setFromLocation(String pFrom) { fromLocation=pFrom; }
    public void setToLocation(String pTo) { toLocation=pTo; }
    public void setDistance(double pDistance) { distance=pDistance; }
    public void setSecurity(int pSecurity) { security=pSecurity; }
    public void setBarriers(String pBarriers) { barriers=pBarriers; }
